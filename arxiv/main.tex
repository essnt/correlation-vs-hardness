...
flips the satisfiability status of 53 of the 82 resolved instance pairs;
the ratio is a composite spanning those status changes (within the 29
status-stable pairs the elevation persists at $\times 11$ and $\times 1.8$
per offset arm,
...
$\Delta{=}{+}0.6$ at 4 of the 9 radii (deviation E3b-$\Delta$).
