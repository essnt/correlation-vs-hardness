...
treewidth bounds (both CIs exclude zero).
...
adapted rule (see Appendix~\ref{app:protocol}, AMEND-5), \textbf{mediation is
established} as mechanism evidence.}
\begin{tabular}{lccc}
\toprule
...
bound, ${\sim}83\%$). The width channel is confirmed directly and all six
recorded mediator paths agree.
