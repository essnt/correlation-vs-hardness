...
satisfiability status of 53 instance pairs; post-hoc causal mediation
analysis is consistent with ${\sim}94\%$ of the radius effect flowing
...
\emph{anti}-conservative, bounded above by the $0.16$-decade spread between
the $r{=}0.06$ arm endpoints.
...
the audit trail is the Zenodo deposit of 2026-09-15 (\S\ref{sec:repro}) ---
we disclose this freeze-to-publication gap rather than let
...
confirmatory weight for the causal claim rests with E3b.
