...
\authornote{Independent Researcher.}
...
interact only within small neighbourhoods, constraint solvers should scale
...
satisfiability status of 53 instance pairs; causal mediation attributes
${\sim}94\%$ of the radius effect to community-structure restructuring (ACME
3.06, bootstrap CI $[2.84, 3.37]$).

{\bf Conclusions:} Locality is not merely correlated with tractability ---
under our controls it is the causal channel. All claims are scoped to
...
adjusted $R^2 \approx 0.31$ on application instances, and treewidth features
alone reach only $0.05$. \citet{mull2016} prove that
...
the 9 radii; $r{=}0.06$ anchors are historical pilot crossings --- conservative
...
2.5 at $r=0.06$ and near ${\approx}4.4$ by $r=0.3$, before difficulty
...
$0.66$ (random); treewidth features add almost nothing on application
instances; sub-category correlations are strong but \emph{sign-flipping}
...
SAT with clustering; their planting threshold is consistent with naive planted
...
content-arm disposition record). A prespecification-vs-implementation audit
...
threshold estimation) fixed \emph{before} the main scan fired. One exploratory
...
Collapsing the duplicate pair $r{=}0.8$ and $r{=}1.5$ into a single level
(identical clause sets, \S\ref{sec:setup}) gives the same conclusion,
...
$5.77$ at $r{=}0.8$,
${\approx}4.5$ orders).
Partial $\eta^2$ at computable cells is $0.984$--$0.988$ against the
...
acts as a suppression channel (negative direct effect), evidence of a
secondary pathway bypassing community structure. All CIs exclude zero: by the
preregistered rule, \textbf{mediation is established} as mechanism evidence.}
\label{tab:mediation}
\end{table}
...
was preregistered at 4 of the 9 radii; $r{=}0.8$ and $r{=}1.5$ generate
...
\toprule
$\Delta$ & $r$ & 0.06 & 0.08 & 0.11 & 0.15 & 0.22 & 0.3 & 0.5 & 0.8 & 1.5\\
\midrule
\multicolumn{11}{l}{\emph{CaDiCaL}}\\
$+0.2$ & & 1.45 (30) & 1.68 (30) & 2.30 (30) & 3.02 (30) & 4.86 (30) & 5.87 (9) & 5.93 (2) & --- & ---\\
$+0.4$ & & 1.40 (29) & 1.64 (30) & 2.08 (30) & 2.75 (30) & 4.39 (30) & 5.73 (23) & 5.88 (10) & 5.91 (4) & 5.91 (4)\\
$+0.6$ & & --- & 1.57 (30) & --- & 2.50 (30) & --- & 5.47 (29) & --- & --- & 5.88 (18)\\
$+0.8$ & & 1.29 (29) & 1.41 (30) & 1.79 (30) & 2.45 (29) & 3.84 (30) & 5.25 (30) & 5.69 (30) & 5.77 (28) & 5.77 (28)\\
\midrule
\multicolumn{11}{l}{\emph{Glucose}}\\
$+0.2$ & & 1.46 (30) & 1.64 (29) & 2.16 (29) & 3.01 (30) & 4.90 (30) & 5.88 (10) & 5.95 (4) & --- & ---\\
$+0.4$ & & 1.40 (28) & 1.57 (30) & 2.00 (30) & 2.62 (30) & 4.47 (30) & 5.70 (25) & 5.86 (16) & 5.86 (5) & 5.86 (5)\\
$+0.8$ & & 1.27 (30) & 1.41 (30) & 1.66 (29) & 2.40 (30) & 3.90 (30) & 5.21 (30) & 5.55 (30) & 5.64 (29) & 5.64 (29)\\
\bottomrule
\end{tabular}
\caption{Complete dose--response grid. Partial $\eta^2$ at the
RM-ANOVA-computable arms: $0.988$ ($\Delta{=}{+}0.6$, CaDiCaL), $0.986$
($\Delta{=}{+}0.8$, CaDiCaL), $0.985$ ($\Delta{=}{+}0.8$, Glucose) ---
against the preregistered confirmation threshold of $0.14$.}
\label{tab:e3afull}
\end{table}
