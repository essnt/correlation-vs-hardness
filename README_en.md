...
This is a falsifiable, experimental incarnation of a philosophical conjecture —
"real-world causes are not strongly correlated in any absolute sense, and that
is precisely why the world is computable."
...
```
docs/          audit memos, literature notes, preregistration documents, report
...
- **M0** literature check and novelty positioning (audit memo + Go/No-Go)
